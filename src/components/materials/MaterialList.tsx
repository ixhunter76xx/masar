  ...
  return (
    <div className="grid items-start gap-[1.6rem] min-[1060px]:grid-cols-[minmax(0,1fr)_20rem]">
      {/*
        ...
        اختيار درسٍ من السكّة كان يبدّل المشغّل والعنوان والوصف
        والبيانات **في إطارٍ واحد**: مشهدٌ كامل يحلّ محلّ مشهدٍ كامل
        بلا أي رابطٍ بينهما. والعين تقرأ ذلك انقطاعًا لا انتقالًا —
        وهو أكثر ما يتكرّر في قاعة الدرس: كل درسٍ نقرة.

        `key` على معرّف الدرس يجعل اللوح يُركَّب من جديد، فتُعاد حركة
        `anim-rise` — صعودٌ قصير مع تلاشٍ، `transform` و`opacity`
        وحدهما. ويسقط إلى تلاشٍ صرف عند `prefers-reduced-motion`.

        ولماذا على اللوح كلّه لا على النصّ وحده: المشغّل نفسه هو ما
        يتبدّل، وإبقاؤه ثابتًا بينما يتحرّك ما تحته يفصل الاثنين عن
        بعضهما — وهما شيءٌ واحد.
      */}
