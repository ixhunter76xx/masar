...
--
-- ── لماذا ترحيل واحد لا سلسلة تعديلات ────────────────────────────────
-- منصة مركز حساب انتهت ولن تُستخدم، وقاعدة البيانات تُفرَّغ بالكامل قبل
-- التطبيق. فسلسلة ترحيلات تحوّل مخططًا قديمًا إلى جديد تعني الاحتفاظ
-- بتاريخ لا يُقرأ ولا يُطبَّق على أي بيئة حيّة. مسار يبدأ من نقطة نظيفة.
--
