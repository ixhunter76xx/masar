...
>
> ### ⚠ النطاق `masar-bh.com` معلَّقٌ من المسجِّل — بيد المالك وحده
>
> مقيسٌ 2026-09-14: خوادم الأسماء صارت `verify-contact-details.namecheap.com`
> و`failed-whois-verification.namecheap.com`، والنطاق يُحلّ إلى
> `198.54.117.242` (Namecheap) لا إلى Netlify. أي أن Namecheap **علّقت النطاق
> لفشل التحقّق من بيانات مالكه (WHOIS)** — وهذا ليس عطلًا في الشيفرة ولا في
> النشر. العلاج: رسالة التحقّق في بريد حساب Namecheap، أو تحديث بيانات
> الاتصال من لوحته. وحتى ذلك يعمل الموقع على **`https://hisab-lms.netlify.app`**
> (مقيس: ٢٠٠ بالمحتوى الجديد).
>
